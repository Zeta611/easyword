...
export async function suggestJargonQuery(
  supabase: SupabaseClient<Database>,
  jargon: string,
...
export async function suggestTranslationQuery(
  supabase: SupabaseClient<Database>,
  jargonId: string,
  translation: string,
  comment: string,
...
export async function searchJargonsQuery(
  supabase: SupabaseClient<Database>,
  searchQuery: string,
  limitCount: number,
  offsetCount: number,
...
export async function countSearchJargonsQuery(
  supabase: SupabaseClient<Database>,
  searchQuery: string,
) {
