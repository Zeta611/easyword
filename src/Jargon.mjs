...
var dict = [
  ...
  [
    "curried application",
    "커리형 함수의 적용, 함수의 찻수를 하나씩 낮추는"
  ],
  [
    "curried function",
    "커리방식으로 고차화된 함수, 커리형 함수"
  ],
  [
    "dangling pointer",
  ...
  [
    "functional language",
    "함수 언어, 함수 중심의 언어, 값 중심의 언어"
  ],
  [
    "functional programming",
    "값 중심의 프로그래밍, 함수 중심의 프로그래밍"
  ],
  [
    "functional style",
    "함수 중심 스타일, 값 중심 스타일"
  ...
  [
    "local definition",
    "우물안 정의, 지역적인 정의, 갇힌 정의"
  ],
  [
    "local procedure",
    "갇힌 프로시져, 유효범위가 제한된 프로시져"
  ],
  [
    "local variable",
    "유효범위가 제한된 변수, 갇힌 변수"
  ...
  [
    "polymorphic",
    "다형, 여러 모양의, 여러 타입을 가지는, 다변형"
  ],
  [
    "polymorphic function",
    "인자 타입에 상관없는 함수, 다형 함수"
  ],
  [
    "polymorphic type",
    "다형 타입"
...
var rows = Belt_Array.map(dict, (function (pair) {
        return React.createElement("tr", undefined, React.createElement("td", undefined, pair[0]), React.createElement("td", undefined, pair[1]));
      }));

function Jargon(Props) {
  var header = React.createElement("tr", undefined, React.createElement("th", undefined, "영어"), React.createElement("th", undefined, "한국어"));
  return React.createElement("table", undefined, header, rows);
}
