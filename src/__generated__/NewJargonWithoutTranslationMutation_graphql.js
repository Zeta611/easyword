...
function related_jargon_constraint_decode($$enum) {
  if ($$enum === "related_jargon_pkey") {
    return $$enum;
  }
  
}

function related_jargon_constraint_fromString(str) {
  return related_jargon_constraint_decode(str);
}
...
function related_jargon_update_column_decode($$enum) {
  if ($$enum === "jargon1" || $$enum === "jargon2") {
    return $$enum;
  }
...
function related_jargon_update_column_fromString(str) {
  return related_jargon_update_column_decode(str);
}
...
var Utils = {
  ...
  related_jargon_constraint_decode: related_jargon_constraint_decode,
  related_jargon_constraint_fromString: related_jargon_constraint_fromString,
  ...
  related_jargon_update_column_decode: related_jargon_update_column_decode,
  related_jargon_update_column_fromString: related_jargon_update_column_fromString,
