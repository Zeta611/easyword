...
function related_jargon_select_column_decode($$enum) {
  if ($$enum === "jargon1" || $$enum === "jargon2") {
    return $$enum;
  }
  
}

function related_jargon_select_column_fromString(str) {
  return related_jargon_select_column_decode(str);
}
...
var Utils = {
  ...
  related_jargon_select_column_decode: related_jargon_select_column_decode,
  related_jargon_select_column_fromString: related_jargon_select_column_fromString,
