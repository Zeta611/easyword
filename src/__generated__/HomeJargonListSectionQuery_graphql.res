...
module Types = {
  ...
  @live
  type variables = {
    categoriesFilter: array<jargon_bool_exp>,
    directions: array<jargon_order_by>,
    searchTerm: string,
  }
  @live
  type refetchVariables = {
    categoriesFilter: option<array<jargon_bool_exp>>,
