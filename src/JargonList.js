...
function JargonList(props) {
  ...
  if (props.axis === "English") {
    ...
    match = [
      Belt_Array.map(getConnectionNodes(match$1.data.jargon_connection), (function (node) {
              return [
                      node.id,
                      node.fragmentRefs
                    ];
    ...
    match = [
      Belt_Array.map(getConnectionNodes(match$2.data.jargon_connection), (function (node) {
              return [
                      node.id,
                      node.fragmentRefs
                    ];
