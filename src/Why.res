...
let make = () => {
  <article className="px-6 py-12 max-w-xl mx-auto md:max-w-4xl prose">
    ...
    <p>
      {"사그라들 수 있다. 전문지식이 전문 학자들에만 머문다면 그 분야는 그렇게 쇠퇴할 수 있다. 저변이 좁아지고 깊은 공부를 달성하는 인구는 그만큼 쪼그라들 수 있다."->React.string}
    </p>
    <p>
    ...
    <p>
      {"쉬운 전문용어를 만들때 원칙은 다음과 같다."->React.string}
      <ul>
        ...
        <li>
          {"기존의 권위에 얽매이지 않는다. 기존 용어사전이나 이미 널리퍼진 용어지만 쉽지않다면, 보다 쉬운 전문용어를 찾고 실험한다."->React.string}
        </li>
        <li>
