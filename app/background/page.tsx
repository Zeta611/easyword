    ...
    <div className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      ...
      <section className="flex flex-col gap-3">
        ...
        <p className="text-foreground leading-7">
          ...
          빨아들일 때, 전문가는 두 언어권의 어휘력을 쌍발 엔진으로 공부의 깊이를
          수월하게 이룬다. 
        </p>
        <p className="text-foreground leading-7">
          그래서 우리말 쉬운전문용어는 저변 인구를 넓혀주는
          효과만이 아니다. 모국어의 심연을 활용하여 전문가의 연구력을 글로벌
          탑으로 보다 쉽게 올려주는 비밀병기다. 아직 드러나지 않은, 하지만 진실인
          비밀. 그 곳에 깃발을 세우는 학술문화 벤쳐다.
        </p>
      </section>
